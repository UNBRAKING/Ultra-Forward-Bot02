...
main_buttons = [[
        InlineKeyboardButton('📢 Updates', url='https://t.me/Team_Pbail'),
        InlineKeyboardButton('💬 Support', url='https://t.me/Ps_Support_Group')
        ],[
        InlineKeyboardButton('🛠️ Help', callback_data='help'),
        InlineKeyboardButton('🩷 About', callback_data='about')
        ],[
        InlineKeyboardButton('🧑‍💻 Developer 🧑‍💻', url='https://t.me/Pbail')
        ]]
